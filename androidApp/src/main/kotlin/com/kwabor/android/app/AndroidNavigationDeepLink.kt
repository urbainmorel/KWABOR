...
internal object AndroidNavigationDeepLinkParser {
    fun parse(rawUrl: String): AndroidNavigationDeepLink {
        val rootResult = RootDeepLinkParser.parse(rawUrl)
...
internal fun dispatchAndroidNavigationDeepLink(
    ...
    when (val deepLink = AndroidNavigationDeepLinkParser.parse(delivery.rawUrl)) {
