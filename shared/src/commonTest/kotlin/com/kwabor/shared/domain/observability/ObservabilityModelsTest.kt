...
class ObservabilityModelsTest {
    ...
    @Test
    fun exploreAppearanceKindsDescribeProcessOrderWithoutClaimingColdOrWarmState() {
        assertEquals(
            listOf("first_process_explore", "subsequent_explore"),
            PerformanceExploreAppearanceKind.entries.map(PerformanceExploreAppearanceKind::wireName),
        )
    }
}
