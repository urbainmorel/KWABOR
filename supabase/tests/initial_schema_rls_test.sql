...
VALUES
  ('11111111-1111-4111-8111-111111111111', 'Utilisateur', 'Test', 'cotonou', now()),
  ('22222222-2222-4222-8222-222222222222', 'Promoteur', 'Test', 'cotonou', now()),
  ('33333333-3333-4333-8333-333333333333', 'Admin', 'Test', 'cotonou', now());
