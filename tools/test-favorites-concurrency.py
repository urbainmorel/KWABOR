#!/usr/bin/env python3
"""Run the destructive favorites concurrency harness against Supabase local only."""
...
LOCAL_TEST = (
    REPOSITORY_ROOT / "supabase" / "local-tests" / "favorites_concurrency_test.sql"
)
WRAPPER = (
    REPOSITORY_ROOT
    / "supabase"
    / ".temp"
    / "favorites_concurrency_explicit_local.sql"
)
