#!/usr/bin/env python3
"""Run the destructive notification inbox concurrency harness locally only."""
...
LOCAL_TEST = (
    ...
    / "supabase"
    / "local-tests"
    / "notification_inbox_concurrency_test.sql"
)
WRAPPER = (
    REPOSITORY_ROOT
    / "supabase"
    / ".temp"
    / "notification_inbox_concurrency_explicit_local.sql"
)
