#!/usr/bin/env python3
"""Run the destructive search-history concurrency harness against Supabase local only."""
...
LOCAL_TEST = (
    ...
    / "supabase"
    / "local-tests"
    / "search_history_concurrency_test.sql"
)
WRAPPER = (
    REPOSITORY_ROOT
    / "supabase"
    / ".temp"
    / "search_history_concurrency_explicit_local.sql"
)
